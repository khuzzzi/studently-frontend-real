            ...
            <div className="relative px-8 pt-8 pb-32">
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                    ...
                    <Avatar className="w-[180px] h-[180px]">
                        <AvatarImage src={profilePic} className="bg-[#c3f137] " />
                        <AvatarFallback>CN</AvatarFallback>
                    </Avatar>
                    {/* Bio and Name */}
                    <div className="flex-1 md:pt-12 text-center md:text-left">
                        <h1 className="text-4xl font-bold text-white mb-4">KashanRashid.</h1>
...
const NavItem = ({ text }) => (
    <div className="flex items-center gap-1 text-white text-sm cursor-pointer group">
        <span>{text}</span>
        <FaChevronDown className="h-3 w-3 text-white opacity-80" />
    </div>
);
